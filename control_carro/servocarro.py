...
def main():
    codo = PWM(Pin(17)) #GPIO16
    codo.freq(50) 
    hombro = PWM(Pin(16)) #GPIO17
    hombro.freq(50)
...
# #         
        ...
        cododuty = int(10556*anguloCodo+450000)
        hombroduty = int(-11111*anguloHombro+1750000)
        baseduty = int(-10555*anguloBase+1616666)
